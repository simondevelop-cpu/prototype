...
interface CategorizationSummaryModalProps {
  ...
  onImport?: () => void; // Optional: import handler to import all transactions
  totalTransactionsToImport?: number; // Total number of transactions to import
  importing?: boolean; // Whether import is in progress
}
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">
                {currentView === 'summary' ? 'Auto-categorised expenses' : `${currentView} Transactions`}
              </h2>
        ...
        <div className="p-6 border-t border-gray-200 bg-gray-50 flex justify-between">
          ...
          {onImport && currentView === 'summary' ? (
            <button
              onClick={onImport}
              disabled={importing || totalTransactionsToImport === 0}
            ...
            >
              {importing ? (
                ...
                `Import all ${totalTransactionsToImport} Transactions`
              )}
            </button>
          ) : (
            <button
