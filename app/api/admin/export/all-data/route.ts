...
function getAPIEndpoints(): APIEndpoint[] {
  ...
  return [
    ...
    // Consent
    { endpoint: '/api/consent', method: 'POST', area: 'Consent', access: 'write', description: 'Log consent event', authentication: 'user', variables: 'consentType, metadata', formula: 'INSERT INTO l1_event_facts' },
    { endpoint: '/api/consent/check', method: 'GET', area: 'Consent', access: 'read', description: 'Check if consent was given', authentication: 'user', variables: 'type', formula: 'SELECT from l1_event_facts WHERE event_type' },
    // Statement Upload
    ...
    // Categorization
    { endpoint: '/api/categorization/learn', method: 'POST', area: 'Categorization', access: 'write', description: 'Learn from user correction', authentication: 'user', variables: 'description, category, label', formula: 'INSERT INTO l2_user_categorization_learning' },
    ...
    { endpoint: '/api/categorization/patterns', method: 'GET', area: 'Categorization', access: 'read', description: 'Get categorization patterns', authentication: 'user', formula: 'SELECT from l1_admin_keywords, l1_admin_merchants' },
    // Bookings
    { endpoint: '/api/bookings/available', method: 'GET', area: 'Chat Bookings', access: 'read', description: 'Get available booking slots', authentication: 'user', formula: 'SELECT from l1_admin_available_slots, l1_admin_chat_bookings' },
    { endpoint: '/api/bookings/create', method: 'POST', area: 'Chat Bookings', access: 'write', description: 'Create booking request', authentication: 'user', variables: 'bookingDate, bookingTime, preferredMethod, shareScreen, recordConversation, notes', formula: 'INSERT INTO l1_admin_chat_bookings' },
    { endpoint: '/api/bookings/my-bookings', method: 'GET', area: 'Chat Bookings', access: 'read', description: 'Get user bookings', authentication: 'user', formula: 'SELECT from l1_admin_chat_bookings WHERE user_id' },
    { endpoint: '/api/bookings/update', method: 'PUT', area: 'Chat Bookings', access: 'write', description: 'Update booking', authentication: 'user', variables: 'id, notes, status', formula: 'UPDATE l1_admin_chat_bookings' },
    // Survey
    { endpoint: '/api/survey/submit', method: 'POST', area: 'Survey', access: 'write', description: 'Submit survey response', authentication: 'user', variables: 'q1, q2, q3, q4, q5', formula: 'INSERT INTO l1_survey_responses' },
    // Feedback
    ...
    // User Activity
    { endpoint: '/api/user/edit-counts', method: 'GET', area: 'User Activity', access: 'read', description: 'Get user edit activity counts', authentication: 'user', formula: 'SELECT COUNT from l1_event_facts WHERE event_type' },
    // Admin Endpoints
    ...
    { endpoint: '/api/admin/customer-data', method: 'GET', area: 'Admin', access: 'read', description: 'Get customer onboarding data', authentication: 'admin', formula: 'SELECT from users, l0_pii_users, l1_onboarding_responses' },
    { endpoint: '/api/admin/events-data', method: 'GET', area: 'Admin', access: 'read', description: 'Get all user events', authentication: 'admin', formula: 'SELECT from l1_event_facts' },
    { endpoint: '/api/admin/editing-events', method: 'GET', area: 'Admin', access: 'read', description: 'Get transaction editing events', authentication: 'admin', formula: 'SELECT from l1_event_facts WHERE event_type = transaction_edit' },
    { endpoint: '/api/admin/recategorizations', method: 'GET', area: 'Admin', access: 'read', description: 'Get recategorization log', authentication: 'admin', formula: 'SELECT from l2_user_categorization_learning' },
    { endpoint: '/api/admin/cohort-analysis', method: 'GET', area: 'Admin', access: 'read', description: 'Get cohort analysis data', authentication: 'admin', variables: 'totalAccounts, validatedEmails, cohorts, intentCategories, dataCoverage', formula: 'Complex aggregations from users (non-PII only), l1_transaction_facts (tokenized_user_id), l1_event_facts (tokenized_user_id). NO PII access.' },
    { endpoint: '/api/admin/vanity-metrics', method: 'GET', area: 'Admin', access: 'read', description: 'Get vanity metrics (Total users, WAU, MAU, New users, Transactions, Recategorizations, Statements, Unique banks)', authentication: 'admin', variables: 'totalAccounts, validatedEmails, intentCategories, cohorts, dataCoverage', formula: 'Aggregations from users (non-PII only), l1_transaction_facts (tokenized_user_id), l1_event_facts (login, transaction_edit, bulk_edit, statement_upload events). NO PII access.' },
    { endpoint: '/api/admin/engagement-chart', method: 'GET', area: 'Admin', access: 'read', description: 'Get engagement chart data', authentication: 'admin', variables: 'totalAccounts, validatedEmails, cohorts, intentCategories, dataCoverage, userIds', formula: 'Time-series aggregations from l1_event_facts (tokenized_user_id for analytics, user_id for operational), users (non-PII only). NO PII access.' },
    ...
    { endpoint: '/api/admin/bookings', method: 'GET', area: 'Admin', access: 'read', description: 'Get all chat bookings', authentication: 'admin', formula: 'SELECT from l1_admin_chat_bookings JOIN users' },
    { endpoint: '/api/admin/bookings/update-status', method: 'POST', area: 'Admin', access: 'write', description: 'Update booking status', authentication: 'admin', variables: 'id, status', formula: 'UPDATE l1_admin_chat_bookings SET status' },
    { endpoint: '/api/admin/available-slots', method: 'GET', area: 'Admin', access: 'read', description: 'Get available booking slots', authentication: 'admin', formula: 'SELECT from l1_admin_available_slots' },
    { endpoint: '/api/admin/available-slots', method: 'POST', area: 'Admin', access: 'write', description: 'Set available booking slots', authentication: 'admin', variables: 'slotDate, slotTime, isAvailable', formula: 'INSERT/UPDATE l1_admin_available_slots' },
    ...
    { endpoint: '/api/admin/logins', method: 'GET', area: 'Admin', access: 'read', description: 'Get admin login events', authentication: 'admin', formula: 'SELECT from l1_event_facts WHERE event_type IN (admin_login, admin_tab_access) AND is_admin = true' },
    { endpoint: '/api/admin/log-action', method: 'POST', area: 'Admin', access: 'write', description: 'Log admin action', authentication: 'admin', variables: 'actionType, tab', formula: 'INSERT INTO l1_event_facts' },
    { endpoint: '/api/admin/keywords', method: 'GET', area: 'Admin', access: 'read', description: 'Get categorization keywords', authentication: 'admin', formula: 'SELECT from l1_admin_keywords' },
    { endpoint: '/api/admin/keywords', method: 'POST', area: 'Admin', access: 'write', description: 'Create keyword', authentication: 'admin', variables: 'keyword, category, label, isActive, notes', formula: 'INSERT INTO l1_admin_keywords' },
    { endpoint: '/api/admin/keywords/[id]', method: 'PUT', area: 'Admin', access: 'write', description: 'Update keyword', authentication: 'admin', variables: 'id, keyword, category, label, isActive, notes', formula: 'UPDATE l1_admin_keywords' },
    { endpoint: '/api/admin/keywords/[id]', method: 'DELETE', area: 'Admin', access: 'write', description: 'Delete keyword', authentication: 'admin', variables: 'id', formula: 'DELETE FROM l1_admin_keywords' },
    { endpoint: '/api/admin/merchants', method: 'GET', area: 'Admin', access: 'read', description: 'Get merchant patterns', authentication: 'admin', formula: 'SELECT from l1_admin_merchants' },
    { endpoint: '/api/admin/merchants', method: 'POST', area: 'Admin', access: 'write', description: 'Create merchant pattern', authentication: 'admin', variables: 'merchantPattern, alternatePatterns, category, label, isActive, notes', formula: 'INSERT INTO l1_admin_merchants' },
    { endpoint: '/api/admin/merchants/[id]', method: 'PUT', area: 'Admin', access: 'write', description: 'Update merchant pattern', authentication: 'admin', variables: 'id, merchantPattern, alternatePatterns, category, label, isActive, notes', formula: 'UPDATE l1_admin_merchants' },
    { endpoint: '/api/admin/merchants/[id]', method: 'DELETE', area: 'Admin', access: 'write', description: 'Delete merchant pattern', authentication: 'admin', variables: 'id', formula: 'DELETE FROM l1_admin_merchants' },
    ...
    { endpoint: '/api/admin/view-keywords', method: 'GET', area: 'Admin', access: 'read', description: 'View keywords for categorization', authentication: 'admin', formula: 'SELECT from l1_admin_keywords' },
...
function getTableDescription(tableName: string): string {
  const descriptions: { [key: string]: string } = {
    ...
    'l1_onboarding_responses': 'User onboarding responses. Stores answers from the onboarding flow (non-PII only - PII migrated to l0_pii_users).',
    'l1_event_facts': 'Event facts table. Tracks all user and admin actions, consent events, and system events. Uses user_id for operational queries, tokenized_user_id for analytics. See Foreign Keys sheet for relationships.',
    ...
    'l2_user_categorization_learning': 'Categorization learning patterns. Stores user corrections for automatic categorization. See Foreign Keys sheet for relationships.',
    'l1_admin_keywords': 'Admin-defined keyword patterns for transaction categorization.',
    'l1_admin_merchants': 'Admin-defined merchant patterns for transaction categorization.',
    'l1_admin_chat_bookings': 'Chat booking requests. Stores user requests for 20-minute chat sessions. Notes field may contain unstructured PII. See Foreign Keys sheet for relationships.',
...
function getSheetName(tableName: string): string {
  const sheetNameMap: { [key: string]: string } = {
    ...
    'l1_admin_keywords': 'l1_admin_keywords',
    'l1_admin_merchants': 'l1_admin_merchants',
    'l1_onboarding_responses': 'l1_onboarding_responses',
    'l1_survey_responses': 'l1_survey_responses',
    'l1_event_facts': 'l1_event_facts',
  };
...
export async function GET(request: NextRequest) {
  try {
    ...
    // Filter out dropped/legacy tables that should not exist (old table names that have been migrated)
    const excludedTables = ['l1_events', 'user_events', 'transactions', 'accounts', 'insight_feedback', 
      'onboarding_responses', 'survey_responses', 'admin_categorization_learning', 'categorization_learning',
      'admin_keywords', 'admin_merchants', 'admin_available_slots', 'admin_chat_bookings', 'chat_bookings', 'available_slots'];
